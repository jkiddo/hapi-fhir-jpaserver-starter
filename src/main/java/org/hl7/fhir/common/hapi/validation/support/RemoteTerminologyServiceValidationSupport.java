...
public class RemoteTerminologyServiceValidationSupport extends BaseValidationSupport implements IValidationSupport {
	...
	@Override
	public ValueSetExpansionOutcome expandValueSet(ValidationSupportContext theValidationSupportContext, @org.jetbrains.annotations.Nullable ValueSetExpansionOptions theExpansionOptions, @NotNull String theValueSetUrlToExpand) throws ResourceNotFoundException {
		return null;
	}
